...
subdat <- dplyr::filter(rawdat, rawdat$Year %in% c(2000:2019), rawdat$Disaster.Type=="Earthquake" | rawdat$Disaster.Type=="Drought") %>% 
  dplyr::select(c("Year","ISO","Disaster.Type"))
